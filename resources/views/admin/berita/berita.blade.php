            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p><a href="{{ url('admin/berita/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Tambah Berita</a></p>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($berita->created_at)
                                                {{ $berita->created_at->format('l, d F Y - H:i') }}
                                        </td>
                                    @else
                                        -
                                @endif
                                <td>
                                    <form action="{{ url('admin/berita/' . $berita->id_berita) }}" method="POST">
                                        <a href="{{ url('admin/berita/' . $berita->id_berita . '/edit') }}"
