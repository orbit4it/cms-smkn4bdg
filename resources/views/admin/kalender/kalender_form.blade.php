    ...
    <div class="row">
    	<div class="col-xs-12">
    		<div class="panel panel-default">
				...
				<form action="{{ @$kalender ? url('admin/kalender/' . $kalender->id_kalender . '/update') : url('admin/kalender/store') }}" method="POST" enctype="multipart/form-data" class="form-kalender">
					{{ csrf_field() }}
					@if (@$kalender)
					{{ method_field('PATCH') }}
					@endif
