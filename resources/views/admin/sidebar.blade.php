    ...
    <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
        <div class="sidebar-collapse menu-scroll">
            <ul id="side-menu" class="nav">
                <li class="user-panel">
                    <div class="thumb">
                        <img src="{{ asset('assets') }}/images/avatar/avatar6_big.png" alt=""
                            class="img-circle" />
                    </div>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="{{ url('/prestasi') }}"><i class="fa fa-home"></i><span
                                    class="submenu-title">Homepage Prestasi</span></a>
                        </li>
                        <li><a href="{{ url('/prestasi/admin/home') }}"><i class="fa fa-archive"></i><span
                                    class="submenu-title">
                                    Data Prestasi
                                </span></a>
                        </li>
